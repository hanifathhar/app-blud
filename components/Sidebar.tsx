...
const menus: MenuItem[] = [
  ...
  },
  {
    ...
    roles: ["superadmin", "kpa", "keuangan", "bendahara", "operator"],
    children: [
      { label: "Penerimaan Pendapatan", href: "/dashboard/penatausahaan/penerimaan", roles: ["superadmin", "kpa", "keuangan", "bendahara"] },
      { label: "Permintaan Belanja", href: "/dashboard/penatausahaan/belanja/permintaan", roles: ["superadmin", "kpa", "keuangan", "bendahara", "operator"] },
      { label: "Pengadaan", href: "/dashboard/penatausahaan/belanja/pengadaan", roles: ["superadmin", "kpa", "keuangan", "bendahara", "operator"] },
      { label: "Penerimaan Barang (BAST)", href: "/dashboard/penatausahaan/belanja/penerimaan", roles: ["superadmin", "kpa", "keuangan", "bendahara", "operator"] },
      { label: "Tagihan (Invoice)", href: "/dashboard/penatausahaan/belanja/tagihan", roles: ["superadmin", "kpa", "keuangan", "bendahara"] },
      { label: "SPP", href: "/dashboard/penatausahaan/spp", roles: ["superadmin", "kpa", "keuangan", "bendahara"] },
      { label: "SPM", href: "/dashboard/penatausahaan/spm", roles: ["superadmin", "kpa", "keuangan", "bendahara"] },
      { label: "SP2D", href: "/dashboard/penatausahaan/sp2d", roles: ["superadmin", "kpa", "keuangan", "bendahara"] },
      { label: "BKU", href: "/dashboard/penatausahaan/bku", roles: ["superadmin", "kpa", "keuangan", "bendahara"] },
    ],
  },
  {
    label: "Pelaporan",
