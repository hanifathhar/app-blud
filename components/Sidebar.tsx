...
const menus: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Pendapatan", href: "/dashboard/penatausahaan/penerimaan", roles: ["superadmin", "kpa", "keuangan", "bendahara"] },
      ...
      { label: "Pengeluaran", href: "/dashboard/penatausahaan/belanja/pengeluaran", roles: ["superadmin", "kpa", "keuangan", "bendahara"] },
